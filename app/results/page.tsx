    ...
    <div className="max-w-screen-xl mx-auto space-y-12 md:space-y-32 pb-20 text-left">
        ...
        {error ? (
          <div className="py-24 text-center space-y-8 bg-white/5 rounded-[3rem] border border-white/5 px-6">
            ...
            <Button onClick={() => router.push('/scanner')} className="px-10 h-16 bg-white text-black rounded-2xl font-black uppercase text-[10px] tracking-widest">Retry Scan</Button>
          </div>
        ) : analysisData ? (
          <motion.div 
          ...
          >
            ...
            <div className="space-y-8 lg:sticky lg:top-24">
               ...
               <div className="grid gap-4">
                  <Button onClick={() => router.push('/scanner')} className="h-14 md:h-16 bg-white text-black hover:bg-[#E1784F] hover:text-white rounded-2xl font-black uppercase tracking-widest text-[9px] shadow-xl transition-all">
                    Start New Scan
                  </Button>
