...
import { ChevronLeft, Zap, Globe, HeartPulse, Stethoscope, Users, ArrowRight, ShieldCheck } from "lucide-react"
...
export default function MissionPage() {
  ...
  return (
    <main className="min-h-[100svh] bg-white dark:bg-[#050505] text-black dark:text-white transition-colors duration-500 selection:bg-[#E1784F]/30 relative overflow-x-hidden">
      ...
      {/* Breadcrumb — lightweight, non-sticky, part of content flow */}
      <div className="max-w-screen-xl mx-auto px-6 py-16 md:py-32 space-y-20 md:space-y-28 relative z-10">
        
        <button 
          onClick={() => router.back()} 
          className="group inline-flex items-center gap-3 text-[#E1784F] font-black text-[10px] tracking-[0.4em] transition-all"
        >
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[6rem] font-black italic capitalize tracking-[-0.06em] leading-[0.8] text-black dark:text-white">
            Bridging the <br /> <span className="text-[#E1784F]">Care Gap.</span>
          </h1>
          <p className="text-lg md:text-2xl lg:text-3xl font-medium leading-tight max-w-3xl opacity-60 tracking-tighter">
        ...
        <section className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-10">
            <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter leading-[0.9]">
            ...
            <div className="flex items-center gap-6 p-6 md:p-8 bg-gray-50 dark:bg-white/5 rounded-[2rem] md:rounded-[3rem] border border-gray-100 dark:border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 md:p-10 bg-black dark:bg-white text-white dark:text-black rounded-[2.5rem] md:rounded-[4rem] text-center space-y-4 shadow-2xl">
            ...
            <div className="p-8 md:p-10 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] md:rounded-[4rem] border border-gray-100 dark:border-white/10 text-center space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-16 lg:gap-24 py-16 md:py-24 border-y border-gray-100 dark:border-white/10">
          {[
        ...
        <section className="grid lg:grid-cols-2 gap-20 items-start">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="p-8 md:p-12 lg:p-20 bg-black dark:bg-white text-white dark:text-black rounded-[2.5rem] md:rounded-[4rem] lg:rounded-[5rem] relative overflow-hidden shadow-2xl"
          >
            ...
            <blockquote className="text-3xl md:text-5xl lg:text-6xl italic font-black leading-[0.95] tracking-tighter relative z-10">
              "We are not just building AI — we are restoring dignity in care. Everyone deserves to be seen."
            </blockquote>
          </motion.div>

          <div className="space-y-12 py-10">
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-black italic capitalize tracking-tighter leading-[0.9]">The Vision</h2>
