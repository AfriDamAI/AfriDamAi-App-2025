        ...
        <main className="min-h-screen bg-white dark:bg-[#050505] text-black dark:text-white transition-colors duration-500 selection:bg-[#E1784F]/30 overflow-x-hidden text-left">
            ...
            <section className="relative py-20 lg:py-32 overflow-hidden bg-[#1C1A19]">
                ...
                <div className="relative max-w-7xl mx-auto px-6">
                    <button
                        onClick={() => router.push('/')}
                        className="inline-flex items-center gap-2 text-[#4DB6AC] text-[9px] font-black tracking-[0.3em] mb-10 hover:brightness-110 transition-all bg-white/5 backdrop-blur-md px-5 py-3 rounded-full border border-white/10 active:scale-95"
                    >
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {[
                        ...
                        <div key={i} className="text-left">
                            <p className="text-2xl md:text-3xl font-black italic text-[#E1784F] leading-none">{stat.val}</p>
                            <p className="text-[8px] font-black tracking-[0.2em] opacity-40 mt-2">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </section>
                ...
                <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-start">
                    ...
                    >
                        <div className="mb-10">
                            ...
                            <p className="text-[#4DB6AC] text-[9px] font-black tracking-[0.2em]">Our team will get back to you shortly</p>
                        </div>
                        <ContactForm />
                    </motion.div>
                    ...
                    <div className="space-y-12">
                        <div className="grid gap-10">
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    <h3 className="font-black text-[10px] tracking-widest mb-1 text-[#4DB6AC]">Headquarters</h3>
                                    <p className="text-xl font-black italic">Lagos, Nigeria</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    <h3 className="font-black text-[10px] tracking-widest mb-1 text-[#E1784F]">Call or WhatsApp</h3>
                                    <a href="tel:+2349025643150" className="text-xl font-black italic hover:text-[#E1784F] transition-colors">
                                        +234 902 564 3150
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-6 group">
                                ...
                                <div>
                                    <h3 className="font-black text-[10px] tracking-widest mb-1 opacity-40">Email</h3>
                                    <a href="mailto:hello@afridamai.com" className="text-xl font-black italic hover:text-[#4DB6AC] transition-all">
                                        hello@afridamai.com
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-[#4DB6AC]/10 to-transparent rounded-[2.5rem] p-10 border border-[#4DB6AC]/20 relative overflow-hidden shadow-lg group">
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <p className="text-xs font-bold tracking-tight opacity-60 leading-relaxed">
                                ...
                                <button
                                    ...
                                    className="bg-black dark:bg-white text-white dark:text-black px-10 py-5 rounded-2xl font-black text-[10px] tracking-widest hover:bg-[#4DB6AC] hover:text-white transition-all shadow-xl active:scale-95"
                                >
                                    Launch Scanner
                                </button>
                            </div>
