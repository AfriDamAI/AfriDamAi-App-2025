...
export default function PublicScanner() {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      // 🛡️ SYNC: analyzePublicSkin already extracts errorData.message and throws it as an Error
      setErrorDetails(err.message || "The AI Brain is busy. Please check your internet and try again.");
      setStatus("Try Again")
    } finally {
