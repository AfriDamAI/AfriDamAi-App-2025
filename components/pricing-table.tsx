    ...
    <div className="w-full space-y-10 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pb-12">
        {PLANS.map((plan, i) => (
          <div 
            key={i}
            className={`relative p-8 rounded-[2.8rem] border transition-all flex flex-col justify-between group ${
              plan.highlight 
          ...
          >
            ...
            <button 
              ...
              className={`w-full mt-10 h-16 rounded-2xl font-black uppercase tracking-widest text-[9px] transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 ${
              plan.highlight 
